...
|------------------------|----------------------------|
| Assumes no prior exposure | Assumes prior exposure but low fluency |
| Teaches definitions first | Rebuilds recognition into execution |
| Often stays at toy examples | Moves toward realistic practice |
